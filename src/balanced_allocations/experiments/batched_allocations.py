...
class batched_allocations(BaseExperiment): 
    def __init__(self, m: int, n_values: list[int], trials: int, d: int, batch: int):
    ...
    def run(self):
        ...
        self.results = simulation.ball_simulator(self.m, self.n_values, self.trials, self.d, self.batch)
